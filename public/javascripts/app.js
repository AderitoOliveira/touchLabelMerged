...
app.controller('editTechSheet', function ($scope, $http, $rootScope, $stateParams, $state, $templateCache) {
 ...
 $scope.printTechnicalSheet = function() {
  ...
  var image = './public/images' + '/' + 'vasoAzul200x200.jpg';
  //var imageData=$base64.encode(image);

  var file = new FileReader(image);
  var dd = {
    content: [
            {
              columns: [
                          ...
                          width: '*',
                          image: 'data:image/jpeg;base64,',
                          //image: 'http://localhost:3700/images/vasoAzul200x200.jpg',
                          //image: './../images/vasoAzul200x200.jpg',
                          //fit: [100.875 , 104.813],
                          width: 150, 
                          height: 150
                        },
