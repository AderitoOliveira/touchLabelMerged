...
//historical.service('LabelsBackupService', ['$scope', '$http', '$rootScope', '$state', 'sendZPLCodeToPrinter', function($scope, $http, $rootScope, $state, sendZPLCodeToPrinter) {
  historical.controller('LabelsBackupController', ['$scope', '$http', '$rootScope', '$state', 'sendZPLCodeToPrinter', 'ModalService', function ($scope, $http, $rootScope, $state, sendZPLCodeToPrinter, ModalService) {
...
historical.controller('printAllLabelsModalController', ['$scope', 'dataObj', 'message', 'sendZPLCodeToPrinter', 'ModalService', 
